...
// long long int routes(int v,vector<int> neighbours[],int final,int parent)
// {
...
//     {
//         vroutes +=(routes(neighbour,neighbours,final,v)%m);
//         vroutes=vroutes%m;
//     }
//     return vroutes;
// }
...
//     }
//     long long totalroutes = routes(0,neighbours,n-1,-1);
//     // cout<<"\n";
//     cout<<totalroutes;
// }
