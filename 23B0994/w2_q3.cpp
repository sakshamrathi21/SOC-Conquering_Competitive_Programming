...
int main(){
    ...
    if(strt!=endd){
        auto ittu=find(vect2.begin(),vect2.end(),vect1[i])-vect2.begin();
        cout<<ittu+1<<" ";
        vect2[ittu]=0;
        ittu=find(vect2.begin(),vect2.end(),vect1[strt])-vect2.begin();
        cout<<ittu+1<<" ";
        vect2[ittu]=0;
        ittu=find(vect2.begin(),vect2.end(),vect1[endd])-vect2.begin();
        cout<<ittu+1;
        return 0;
    }
    }
